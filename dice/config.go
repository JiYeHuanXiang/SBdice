...
%}`, 1},
		...
		"核心": {
			...
			"骰子执行异常": {
				{"指令执行异常，请联系某个脑瘫，群号524364253，非常感谢。", 1},
			},
			"骰子开启": {
		...
		"娱乐": {
			"今日人品": {
				{"人品：{$t人品}\n你知道吗，听说海豹曾找过外包程序员，花了昂贵的300人民币", 1},
			},
			"鸽子理由": guguReason,
		},
		"其它": {
		...
		if d.VersionCode != 0 && d.VersionCode < 10300 {
			...
			d.RunAfterLoaded = append(d.RunAfterLoaded, func() {
				...
				for index, text := range d.TextMapRaw["娱乐"]["鸽子理由"] {
					srcText := text[0].(string)
					srcText = strings.ReplaceAll(srcText, "你知道吗，海豹在被帮助后，会说你指手画脚","你知道吗，SZZrain人菜瘾大，赶走极夜幻想后从未有过实质性更新",  "你知道吗，据某人所说 木落没有常识")
